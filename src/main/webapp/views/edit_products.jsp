				...
				<form action="/update" method="post">
					<div class="mb-3">
						<label for="name" class="form-label">Product Name</label> <input
							type="text" value="${data.product.name}" class="form-control"
							name="name" id="name" placeholder="Enter product name"> <input
							type="hidden" value="${data.product.id}" class="form-control"
							name="id" id="productId">
					</div>

					<div class="mb-3">
						<label for="quantity" class="form-label">Product Quantity</label>
						<input type="number" value="${data.product.quantity}"
					...
					<div class="mb-3">
						<label for="price" class="form-label">Product Price</label> <input
							type="number" value="${data.product.price}" class="form-control"
